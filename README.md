...
### hobson-hub-foscam-ipcamera

The Foscam IP Camera plugin provides the ability for the Hobson Hub to discover and view images/video from
Foscam IP cameras on the same network.